...
export class ReportWriter {
  ...
  /**
   * Build a frontmatter object from a ReportContext. Validates against $defs.reportFrontmatter.
   */
  ...
  /**
   * Write a report to AgentReports/Bridge/<file_name | <tool>_<compact-iso>.md>.
  ...
  static compactIso(d: Date): string {
    // "2026-05-18T01:23:45.123Z" -> "2026-05-18T012345Z"
