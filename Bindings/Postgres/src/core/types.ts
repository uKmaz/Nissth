...
export interface BindingManifestData {
  ...
  scope_extra_keys_doc?: Record<string, string> | Record<string, Record<string, string>>;
}

/**
 * Parsed libpq connection-string components. Password is the literal value;
 * use ConnectionManager.redactForLog() before emitting anywhere.
 */
