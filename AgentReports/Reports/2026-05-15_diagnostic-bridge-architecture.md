...
- Süprüz inherits the bridge for free when its bootstrap resumes.
...
**Carry-overs:**
- Süprüz bootstrap (paused since 2026-05-07) stays paused until the Spring Boot binding's first slice is usable. The bootstrap sequence (PDF relocation, SRS/SDD authoring, PostGIS in §8.1, `Phase_00_DBL_Bootstrap.md`) is unaffected and will resume after Phase 05 closes.
