...
> **Companion** — the Example-Backend session's `StatusUpdate.md` entry at `C:\Users\admin\Desktop\Example\src\example-backend\AgentReports\StatusUpdate.md` (2026-05-23 22:13) is the upstream discovery record. This Report captures the framework-side close.
...
```powershell
Push-Location 'C:\Users\admin\Desktop\Example\src\example-backend'
$env:NISSTH_PG_URL = 'postgresql://appdb_user:<REDACTED>@<db-host>/appdb?sslmode=no-verify'
...
Result:
- Exit code: **0**
- Report at `C:\Users\admin\Desktop\Example\src\example-backend\AgentReports\Bridge\migration_status_2026-05-23T214606Z.md`
