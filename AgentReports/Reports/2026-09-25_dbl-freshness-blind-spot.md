...
covers:
  ...
  - the ExampleFinanceApp consumer's DBL
supersedes:
  - none
---
...
| 2026-09-13 → 09-22 | The ExampleFinanceApp consumer runs `dbl-check --strict` at each phase close, part of its §5 sweep. It reports clean every time. The consumer writes annotated refs throughout, in good faith — §7.2 says "`<git commit hash, OR …>`" and does not forbid a note. |
