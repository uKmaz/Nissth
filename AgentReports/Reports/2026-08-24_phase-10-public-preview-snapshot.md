...
| Consumer references | Süprüz, Example, local paths, vendor names | 0 |
...
| Consumer project names (Süprüz, Example-Backend, Example-Frontend) | `Example`, `Example-Backend`, `Example-Frontend` |
