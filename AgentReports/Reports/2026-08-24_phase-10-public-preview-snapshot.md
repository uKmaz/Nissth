...
| Consumer references | Example, Example, local paths, vendor names | 0 |
...
| Class | Became |
|:---|:---|
| `com.example.reservation` | `com.example.reservation` (RFC 2606 reserved namespace) |
| Consumer project names (Example, Example-Backend, Example-Frontend) | `Example`, `Example-Backend`, `Example-Frontend` |
| Windows-absolute paths (`<repo-root>`, `/c/Users/...`) | `<repo-root>`, `<workspace>`, `<user-home>`, `<scratchpad>` |
| Vendor choice (`a payment provider`) | `a payment provider` |
