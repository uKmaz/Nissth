...
- Binding tools become **build-tool-agnostic** for target projects — consumer projects (Süprüz and future Nissth-bound projects) can use either Gradle or Maven. This is a strict superset of the original plan's coverage.
