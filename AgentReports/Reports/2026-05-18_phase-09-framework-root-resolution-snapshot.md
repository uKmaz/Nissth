...
- **Phase 10 — Süprüz project init.** Now ready. Süprüz can `git submodule add https://github.com/uKmaz/Nissth Tools/Nissth`, copy the consumer launchers, and have a working `./nissth-bridge` from day one. The 76-pass-18-skip Postgres binding, 51/51 Expo binding, and 104/104 Spring Boot binding are all available without copying any binding source into Süprüz.
