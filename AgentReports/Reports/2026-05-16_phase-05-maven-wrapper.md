...
- Consumer projects pulling this binding (Example, future stacks adopting the Spring Boot binding) no longer need to install Maven separately — `./mvnw` works out of the box.
