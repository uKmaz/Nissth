...
- **Süprüz consumer project** (`Desktop/Supruz/`) — now fully unblocked. The Süprüz project can install one `nissth-bridge` on PATH and use any of the three Nissth bindings via a single command surface.
