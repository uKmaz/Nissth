...
| ~02:5x | Step 2 failed with `ENOENT: no such file or directory, open 'C:\Users\admin\Desktop\Example\src\Example-Frontend\Bindings\_schemas\bridge-command.schema.json'`. |
