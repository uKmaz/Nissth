...
- **Depends on:** Phase_19_Bridge_Flip_And_Yaml (closed 2026-09-23, `86ad0a3`/`539ae31`); the FinansYönetimApp digest (`AgentReports/Reports/2026-09-13_nissth-feedback-digest.md`, 2026-09-23 revision)
...
- [x] **Step 6.** Sync the consumer copy: apply the same §1/§8.2/§11.5 edits to `FinansYönetimApp/CLAUDE.md`, whose banner promises the framework sections are verbatim. **Acceptance:** the two files' framework sections match; the consumer gets its own status entry.
