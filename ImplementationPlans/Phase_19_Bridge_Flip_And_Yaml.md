...
- Consumer evidence (read-only): `ExampleFinanceApp/AgentReports/Bridge/route_lens_2026-09-21T213212Z.md`, `component_lens_2026-09-21T213226Z.md`, `DBL/APIIndex/routes.md`
<!-- plan-lint:allow missing-cited-artifact - the three artifacts on the line above are consumer-relative, inheriting the ExampleFinanceApp prefix from the first of them; none of them is a path in this repo -->
...
- [x] **Field:** **three** lens runs in ExampleFinanceApp leave `DBL/` untouched and `dbl-check` at 17 — 0/0/0.
