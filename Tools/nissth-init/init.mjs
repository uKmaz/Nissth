...
export function plan(opts) {
  ...
  // was one tree comment that a consumer agent never saw — ExampleDesktopApp Phase 00, 2026-09-13.
  ...
  // procedure existed, so ExampleDesktopApp invented a rotation at ~100 KB and carried the gap as an open
